...
#'
#' @export
ggdotchart_not_ordered <- function(data, x, y, group = NULL,
                       combine = FALSE,
  ...
  .opts$fun <- ggdotchart_not_ordered_core
  .opts$fun_name <- "ggdotchart_not_ordered"
...
ggdotchart_not_ordered_core <- function(data, x, y, group = NULL,
                       color = "black",  palette = NULL,
                       shape = 19, size = NULL, dot.size = size,
                       sorting = c("ascending", "descending"),
