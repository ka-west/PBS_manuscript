...
### Figure S4: Maternal metabolic changes depend on type of bariatric surgery
...
figS4 <- ggarrange(serum_dotplot, urine_dotplot, 
                  ncol = 2,
                  widths = c(1, 1.5))

```

```{r save_figS4, echo=FALSE, out.width="110%"}

ggsave(figS4, 
       filename = file.path(save_dir, "figureS4_metabolic_changes.pdf"), 
       width = 180, 
       height = 100, 
       units = "mm")
figS4
