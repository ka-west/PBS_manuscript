...
### Figures S1 and S4: Overlayed median 1H NMR spectra

Serum (Figure S1) and urine (Figure S4) median spectra were overlayed for the three study groups
...
# serum
plot_med_specs(med_specs_serum, save_dir, "figureS1_median_spectra_serum.html")
...
Figure S1 (annotated)
![](output/figureS1_median_spectra_serum.png)  
Figure S4 (annotated)
![](output/figureS4_median_spectra_urine.png)
...
### Figure S2: Maternal metabolic changes depend on type of bariatric surgery
...
figS2 <- ggarrange(serum_dotplot, urine_dotplot, 
                  ncol = 2,
                  widths = c(1, 1.5))

```

```{r save_figS2, echo=FALSE, fig.width=8, fig.height=5}

ggsave(figS2, 
       filename = file.path(save_dir, "figureS2_metabolic_changes.pdf"), 
       width = 180, 
       height = 100, 
       units = "mm")
figS2
...
```{r save_figureS6, echo=FALSE, out.width="120%"}
...
### Figure S7: Key metabolites are not associated with percentage of weight lost or length of time since surgery in malabsorptive patients
...
```{r save_figS7, echo=FALSE, fig.width=9}
